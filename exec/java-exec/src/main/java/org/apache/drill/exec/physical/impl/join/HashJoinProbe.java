...
public interface HashJoinProbe {
  ...
  public abstract void setupHashJoinProbe(VectorContainer[][] buildBatches, RecordBatch probeBatch, HashJoinBatch outgoing, HashTable[] hashTables, HashJoinHelper[] hjHelpers,
                                          JoinRelType
    joinRelType);
