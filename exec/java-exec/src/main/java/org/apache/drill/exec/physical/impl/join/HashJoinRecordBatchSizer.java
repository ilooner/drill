...
public class HashJoinRecordBatchSizer {
  ...
  public HashJoinRecordBatchSizer(RecordBatch batch) {
    this(batch,
  ...
  public HashJoinRecordBatchSizer(VectorAccessible va) {
    this(va, null);
  }
  ...
  public HashJoinRecordBatchSizer(VectorAccessible va, SelectionVector2 sv2) {
