...
public class HashTableSizeCalculatorImpl implements HashTableSizeCalculator {
  ...
  public long calculateSize(final HashJoinMemoryCalculator.PartitionStat partitionStat,
    ...
    long hashTableSize = RecordBatchSizer.multiplyByFactors(computeValueVectorSize(numBuckets, IntVector.VALUE_WIDTH), HASHTABLE_DOUBLING_FACTOR);
    ...
    if (numFullBatchHolders != numBatchHolders) {
      ...
      hashTableSize += RecordBatchSizer.multiplyByFactors(partialSize, HASHTABLE_DOUBLING_FACTOR);
    }
